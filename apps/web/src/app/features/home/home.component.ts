      ...
      jsonLd: [
        {
          ...
          potentialAction: {
            '@type': 'SearchAction',
            target: { '@type': 'EntryPoint', urlTemplate: 'https://perucalcula.pe/guias?q={search_term_string}' },
        ...
        },
        {
          ...
          name: 'Perú Calcula',
          url: 'https://perucalcula.pe',
          description: 'Calculadoras laborales, tributarias y financieras según la normativa peruana vigente.',
          applicationCategory: 'FinanceApplication',
          operatingSystem: 'Web',
          isAccessibleForFree: true,
          inLanguage: 'es-PE',
          offers: { '@type': 'Offer', price: '0', priceCurrency: 'PEN' },
          provider: { '@type': 'Organization', name: 'Perú Calcula', url: 'https://perucalcula.pe' },
        },
        {
          '@context': 'https://schema.org',
          '@type': 'FAQPage',
